# 1. BBDD Configuración del entorno



| Deberemos instalarnos [XAMPP](https://www.apachefriends.org/es/download.html) esto es debido a que xampp tiene integrado MySQL

Dentro de nuestro proyecto tendremos q añadir una carpeta que se localice al mismo nivel que src ahí tendremos que colocar el archivo .jar que descargaremos aquí. [conector](https://mvnrepository.com/artifact/mysql/mysql-connector-java/8.0.22)

| <!-- -->      | <!-- -->        |
|:-------------:|:---------------:|
| <ol align="left"> <li>Pulsar botón derecho sobre el proyecto.</li> <li>Build Path -> Configure Build Path</li> <li>En la pestaña "libraries" pulsar el boton "Add Jar"</li> <li>Buscar la carpeta lib de nuestro proyecto y elegir el fichero mysql-connector-java-8.0.22.jar"</li> </ol>  | <img src="fotos/Untitled.png"> |


# Creación de una bd

Vamos a crear una base de datos de ejemplo para afinar conocimientos.

<p align="center">
  <img src="fotos/Untitled%201.png">
</p>

una vez creada vamos a la pestaña de SQL e insertamos los datos (no es necesario que uses estos datos)
...
('43434343A', 'DELGADO PEREZ MARISA', 'C/ MIRAMAR, 84 3�A', '925-200-967', 'TOLEDO');

INSERT INTO CLIENTE VALUES 
('51592939K', 'LOPEZ VAL SOLEDAD', 'C/ PEZ, 54 4�C', '915-829-394', 'MADRID');

INSERT INTO CLIENTE VALUES 
('51639989K', 'DELGADO ROBLES MIGUEL', 'C/ OCA, 54 5�C', '913-859-293', 'MADRID');

INSERT INTO CLIENTE VALUES
('51664372R', 'GUTIERREZ PEREZ ROSA', 'C/ CASTILLA, 4 4�A', '919-592-932', 'MADRID');
